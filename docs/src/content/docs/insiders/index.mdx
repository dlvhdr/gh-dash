...
`DASH Insiders` is a program you can join by sponsoring me on GitHub and gets you access to
...
<div class="py-4 md:p-4">
  <a href="/enhance" class="no-underline">
    <div class="inline-flex flex-row items-center gap-2 border border-[var(--sl-color-gray-4)] p-4 no-underline hover:bg-[var(--sl-color-gray-6)]">
      <EnhanceMiniLogo />
      <Icon
        name="right-arrow"
        size="24px"
...
1. Get access to my private projects that you can download, use, view the code
   and open issues.
2. Show support for my other fully open source projects

Your support will help me work on more projects and you will automatically get
access to them.
